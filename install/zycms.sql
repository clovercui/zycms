...
INSERT INTO `zycms_areas` (`id`, `areaid`, `area`, `cityid`) VALUES
(1, '110101', '东城区', '110100'),
(2, '110102', '西城区', '110100'),
(3, '110103', '崇文区', '110100'),
(4, '110104', '宣武区', '110100'),
...
--
-- 转存表中的数据 `zycms_cities`
--

INSERT INTO `zycms_cities` (`id`, `cityid`, `city`, `provinceid`) VALUES
(1, '110100', '市辖区', '110000'),
(2, '110200', '县', '110000'),
(3, '120100', '市辖区', '120000'),
(4, '120200', '县', '120000'),
...
INSERT INTO `zycms_flink` (`id`, `name`, `url`, `thumb`) VALUES
...
CREATE TABLE IF NOT EXISTS `zycms_forms` (
  `id` int(10) unsigned NOT NULL COMMENT '表单ID',
...
CREATE TABLE IF NOT EXISTS `zycms_piece` (
  `id` int(10) unsigned NOT NULL COMMENT '碎片ID',
...
--
-- 转存表中的数据 `zycms_provinces`
--

INSERT INTO `zycms_provinces` (`id`, `provinceid`, `province`) VALUES
(1, '110000', '北京市'),
(2, '120000', '天津市'),
(3, '130000', '河北省'),
(4, '140000', '山西省'),
...
--
-- 转存表中的数据 `zycms_relationship`
--

INSERT INTO `zycms_relationship` (`roleid`, `rid`) VALUES
(6, 1),
(6, 3),
(6, 4),
(6, 5),
...
INSERT INTO `zycms_role` (`id`, `name`) VALUES
(6, '超级管理员'),
(7, '测试用户');
...
--
-- Indexes for table `zycms_admin`
--
ALTER TABLE `zycms_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zycms_ad_position`
--
...
--
-- Indexes for table `zycms_forms`
--
ALTER TABLE `zycms_forms`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zycms_hot_search`
--
...
--
-- Indexes for table `zycms_piece`
--
ALTER TABLE `zycms_piece`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zycms_provinces`
--
ALTER TABLE `zycms_provinces`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zycms_relationship`
--
ALTER TABLE `zycms_relationship`
  ADD PRIMARY KEY (`roleid`,`rid`);

--
-- Indexes for table `zycms_right`
--
ALTER TABLE `zycms_right`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zycms_role`
--
...
--
-- AUTO_INCREMENT for table `zycms_ad`
--
ALTER TABLE `zycms_ad`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '广告ID',AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `zycms_flink`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '友链ID',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `zycms_forms`
--
ALTER TABLE `zycms_forms`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '表单ID',AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `zycms_hot_search`
--
ALTER TABLE `zycms_hot_search`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '热搜关键词ID',AUTO_INCREMENT=3;
--
...
ALTER TABLE `zycms_order_product`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID';
--
-- AUTO_INCREMENT for table `zycms_piece`
--
ALTER TABLE `zycms_piece`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '碎片ID',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `zycms_provinces`
--
ALTER TABLE `zycms_provinces`
